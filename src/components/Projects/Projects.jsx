...
const projects = [
...

  {
    ...
    {
    name: 'Cyberify',
    tag: 'Clone · MERN Stack',
    desc: 'Professional design Clone website with a clean layout built to enhance client engagement.',
    ...
    name: 'Link',
    tag: 'Clone · MERN Stack',
    desc: 'Professional Figma design Clone website with a clean layout built to enhance client engagement.',
